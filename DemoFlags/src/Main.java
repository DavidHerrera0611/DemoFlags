...
public class Main {
    ...
    public static int[][] createChileFlag(int height, int width) {
        int[][] flag = new int[height][width];
        int rowIni = 0;
        int rowEnd = 0;
        int cellIni = 0;
    ...
    public static void main(String[] args) {
        ...
        flag = createPOLFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createPOLFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);
        ...
        flag = createPANFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createPANFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createPANFlag(24, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createChileFlag(12,20);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createChileFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createChileFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createChileFlag(24, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createCZEFlag(12,20);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createCZEFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createCZEFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);
        ...
        flag = createDNKFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createDNKFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);
        ...
        flag = createFINFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createFINFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);
        ...
        flag = createNORFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createNORFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);
        ...
        flag = createCHEFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createCHEFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);
        ...
        flag = createKWTFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createKWTFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);
        ...
        flag = createZAFFlag(12, 40);
        JOptionPaneArrays.showColorArray2D(null, flag);

        flag = createZAFFlag(24, 20 );
        JOptionPaneArrays.showColorArray2D(null, flag);
